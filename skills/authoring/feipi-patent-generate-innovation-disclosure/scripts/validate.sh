...
REQUIRED_FILES=(
  ...
  "references/stages/phase-3-final-drafting.md"
  "references/stages/phase-4-review-delivery.md"
...
rg -q '运行时禁止整体读取' "$TARGET_DIR/references/stage-delivery-contract.md"
rg -q '运行时不得整体读取' "$TARGET_DIR/references/content-quality-gates.md"
rg -q 'Skill 运行时不得读取' "$TARGET_DIR/handbook/progressive-loading.md"
rg -q 'agents/subagents/loading-policy\.json' "$TARGET_DIR/SKILL.md"
